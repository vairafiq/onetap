...
namespace oneTap\Utility\Enqueuer;
...
abstract class Enqueuer extends Enqueuer_Base {
    ...
    public function setup_load_min_files() {
        $this->load_min = apply_filters( 'exlac_customer_support_app_load_min_files', ONETAP_LOAD_MIN_FILES );
    }
    ...
    public function setup_script_version() {
        $script_version       = ( $this->load_min ) ? ONETAP_SCRIPT_VERSION : md5( time() );
